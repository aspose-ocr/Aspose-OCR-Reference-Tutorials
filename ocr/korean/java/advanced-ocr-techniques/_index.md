...
### [Java에서 GPU를 활성화하고 이미지에서 텍스트를 추출하는 방법](./how-to-enable-gpu-and-extract-text-from-images-in-java/)
Java용 Aspose.OCR에서 GPU를 활용해 이미지 텍스트 추출 속도를 크게 높이는 방법을 단계별로 안내합니다.
