...
### [C#에서 이미지 기울기 보정하는 방법 – Aspose OCR을 활용한 완전 가이드](./how-to-deskew-image-in-c-complete-guide-using-aspose-ocr/)
Aspose OCR을 사용해 C#에서 이미지를 손쉽게 기울기 보정하는 전체 과정을 안내합니다.
{{< /blocks/products/pf/tutorial-page-section >}}
