...
### [C# में GPU OCR के साथ इमेज फ़ाइल लोड करें और रसीद टेक्स्ट निकालें](./load-image-file-extract-receipt-text-with-gpu-ocr-in-c/)
GPU-त्वरित OCR का उपयोग करके इमेज फ़ाइल से रसीद का टेक्स्ट निकालने की प्रक्रिया सीखें।
