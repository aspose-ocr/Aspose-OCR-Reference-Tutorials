...
### [Πώς να χρησιμοποιήσετε το Aspose OCR για μετατροπή εικόνας σε JSON](./how-to-use-aspose-ocr-to-convert-image-to-json/)
Μάθετε πώς να μετατρέψετε εικόνες σε JSON χρησιμοποιώντας το Aspose OCR σε .NET, βήμα-βήμα οδηγός για εύκολη ενσωμάτωση.
...
### [Πώς να χρησιμοποιήσετε το Aspose για OCR αραβικού κειμένου – Παράδειγμα C# OCR](./how-to-use-aspose-for-ocr-arabic-text-c-ocr-example/)
Μάθετε πώς να εφαρμόσετε το Aspose OCR για αραβικό κείμενο σε C#, βήμα-βήμα οδηγός για ακριβή αναγνώριση.
### [Δημιουργία αρχείου EPUB από εικόνα – Πλήρης οδηγός C# OCR](./create-epub-file-from-image-complete-c-ocr-guide/)
Μάθετε πώς να μετατρέψετε εικόνες σε αρχείο EPUB χρησιμοποιώντας το Aspose.OCR με C#, βήμα-βήμα οδηγός.
### [Αναγνώση κειμένου από εικόνα με Aspose OCR – Πλήρης οδηγός C# Async](./recognize-text-from-image-with-aspose-ocr-complete-c-async-g/)
Μάθετε πώς να αναγνωρίζετε κείμενο από εικόνα χρησιμοποιώντας Aspose OCR σε C# με ασύγχρονη υλοποίηση, βήμα-βήμα οδηγός.
### [Αναγνώριση κειμένου από εικόνα με Aspose OCR – Πλήρης οδηγός C#](./recognize-text-from-image-with-aspose-ocr-complete-c-guide/)
Μάθετε πώς να αναγνωρίζετε κείμενο από εικόνα χρησιμοποιώντας Aspose OCR σε C# με βήμα-βήμα οδηγό.
