...
### [Αναγνώριση αραβικού κειμένου με Aspose OCR – Οδηγός πολλαπλών γλωσσών](./recognize-arabic-text-with-aspose-ocr-multi-language-guide/)
Ανακαλύψτε πώς να χρησιμοποιήσετε το Aspose OCR για .NET ώστε να αναγνωρίζετε αραβικό κείμενο, με οδηγίες βήμα‑βήμα για πολυγλωσσική υποστήριξη.
### [Δημιουργία Αναζητήσιμου PDF σε C# – Οδηγός Βήμα‑βήμα](./create-searchable-pdf-in-c-step-by-step-guide/)
