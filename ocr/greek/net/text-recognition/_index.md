...
### [Πώς να χρησιμοποιήσετε OCR σε C# – Εξαγωγή κειμένου από αρχεία εικόνας](./how-to-use-ocr-in-c-extract-text-from-image/)
Ανακαλύψτε πώς να χρησιμοποιήσετε το OCR σε C# για να εξάγετε κείμενο από αρχεία εικόνας με απλά βήματα.
### [OCR πολλαπλών σελίδων PDF – Μετατροπή σε HTML με C# Aspose OCR](./ocr-multi-page-pdf-convert-to-html-with-c-aspose-ocr/)
Μάθετε πώς να μετατρέψετε PDF πολλαπλών σελίδων σε HTML χρησιμοποιώντας το Aspose.OCR με C#.
### [Πώς να χρησιμοποιήσετε OCR σε C# – Ασύγχρονη εξαγωγή κειμένου από εικόνα](./how-to-use-ocr-in-c-extract-text-from-image-asynchronously/)
...
Μάθετε πώς να εξάγετε κείμενο από εικόνες χρησιμοποιώντας το Aspose OCR με έναν πλήρη οδηγό C# βήμα προς βήμα.
