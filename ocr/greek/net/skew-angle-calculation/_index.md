...
### [Οδηγός OCR για Περιστραμμένο Έγγραφο – Αυτόματη Διόρθωση Λοξότητας & Περιστροφής σε C#](./ocr-rotated-document-tutorial-auto-skew-rotation-fix-in-c/)
Μάθετε πώς να εντοπίζετε και να διορθώνετε αυτόματα τη λοξότητα και την περιστροφή σε έγγραφα OCR χρησιμοποιώντας το Aspose.OCR για .NET σε C#.
{{< /blocks/products/pf/tutorial-page-section >}}
