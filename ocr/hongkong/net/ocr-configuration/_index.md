...
### [在 C# 中載入影像檔案並使用 GPU OCR 提取收據文字](./load-image-file-extract-receipt-text-with-gpu-ocr-in-c/)
...
### [如何在 C# 中執行 OCR 圖像 – 完整指南與 GPU 支援](./how-to-ocr-image-in-c-complete-guide-with-gpu-support/)
