...
### [Создайте консольный логгер и исправьте таблицы с помощью AsposeAI](./create-console-logger-and-correct-tables-with-asposeai/)
Изучите, как создать консольный логгер и исправлять таблицы с помощью AsposeAI для .NET.
{{< /blocks/products/pf/tutorial-page-section >}}
