...
### [Извлечение таблицы из изображения с помощью Aspose OCR – Полное руководство на C#](./extract-table-from-image-with-aspose-ocr-complete-c-guide/)
Подробное руководство по извлечению таблиц из изображений с использованием Aspose OCR в C#. Шаг за шагом от настройки до получения результатов.
### [Как распознать японский язык с помощью Aspose OCR в C# – Полное руководство](./how-to-ocr-japanese-with-aspose-ocr-in-c-full-guide/)
Подробное руководство по распознаванию японского текста с помощью Aspose OCR в C#. Шаг за шагом от настройки до получения результатов.
### [Создание поискового PDF из изображения с OCR – руководство на C#](./create-searchable-pdf-from-image-with-ocr-c-guide/)
Научитесь преобразовывать изображения в PDF с возможностью поиска текста, используя Aspose.OCR и C#.
### [Извлечение текста из изображения в C# – Полное руководство по офлайн OCR](./extract-text-from-image-in-c-complete-offline-ocr-guide/)
Подробное руководство по извлечению текста из изображений в C# с использованием офлайн OCR Aspose. Шаг за шагом от настройки до получения результатов.
### [Создать docx из изображения с Aspose OCR – пошаговое руководство на C#](./create-docx-from-image-with-aspose-ocr-step-by-step-c-guide/)
Подробное руководство по созданию файла docx из изображения с использованием Aspose OCR в C#. Шаг за шагом от настройки до получения результата.
