...
### [Извлечь текст из изображения с помощью Aspose OCR в C#](./extract-text-from-image-using-aspose-ocr-in-c/)
Извлеките текст из изображения с помощью Aspose OCR в C#.
{{< /blocks/products/pf/tutorial-page-section >}}
