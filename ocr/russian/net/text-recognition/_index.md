...
### [Распознать изображение текста с Aspose OCR на C#](./recognize-text-image-with-aspose-ocr-in-c/)
Научитесь распознавать текст на изображениях с помощью Aspose OCR в C#.
{{< /blocks/products/pf/tutorial-page-section >}}
