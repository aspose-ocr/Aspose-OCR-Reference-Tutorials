...
### [Извлечь текст из PNG – чтение текста с изображения с помощью OCR](./extract-text-from-png-read-text-from-image-with-ocr/)
Узнайте, как с помощью Aspose.OCR извлечь текст из PNG‑изображений, используя возможности OCR для точного распознавания.
### [Как выполнить OCR в C# – извлечь арабский текст из изображений](./how-to-perform-ocr-in-c-extract-arabic-text-from-images/)
Узнайте, как с помощью Aspose.OCR извлечь арабский текст из изображений в C#.
### [Создание поискового PDF из сканированных файлов – пошаговое руководство C#](./create-searchable-pdf-from-scanned-files-step-by-step-c-guid/)
Научитесь создавать PDF с возможностью поиска из сканированных изображений, используя Aspose.OCR и C# в этом пошаговом руководстве.
### [Как пакетно выполнять OCR PNG‑изображений в C# – Полное руководство](./how-to-batch-ocr-png-images-in-c-complete-guide/)
Узнайте, как с помощью Aspose.OCR пакетно обрабатывать PNG‑изображения в C#, получая быстрые и точные результаты OCR.
### [Как использовать OCR: преобразовать изображение в HTML в C#](./how-to-use-ocr-convert-image-to-html-in-c/)
Узнайте, как с помощью Aspose.OCR преобразовать изображение в HTML‑страницу в C#.
### [Извлечь текст из изображения с Aspose OCR – пошаговое руководство](./extract-text-from-image-with-aspose-ocr-step-by-step-guide/)
Узнайте, как с помощью Aspose OCR извлечь текст из изображения, следуя пошаговым инструкциям.
### [Как разобрать JSON с помощью OCR Engine C# – Полное пошаговое руководство](./how-to-parse-json-with-ocr-engine-c-complete-step-by-step-gu/)
Узнайте, как с помощью Aspose.OCR в C# разобрать JSON‑результаты OCR, следуя полному пошаговому руководству.
### [c# OCR учебник: Извлечение текста из изображений (WebP, Фото) – Быстрое руководство](./c-ocr-tutorial-extract-text-from-images-webp-photo-quick-gui/)
Узнайте, как быстро извлечь текст из изображений WebP и фото с помощью Aspose.OCR в C#.
