...
### [Создать поисковый PDF с Aspose OCR – Полное руководство на C#](./create-searchable-pdf-with-aspose-ocr-full-c-guide/)
Полное руководство по созданию PDF с возможностью поиска, используя Aspose OCR в C#.
...
### [OCR китайский упрощенный: офлайн OCR с Aspose в C# – Полное руководство](./ocr-chinese-simplified-offline-ocr-with-aspose-in-c-complete/)
Полное руководство по офлайн-распознаванию упрощённого китайского текста с помощью Aspose OCR в C#.
### [Выполнить OCR изображения в C# – Полный пример Aspose OCR](./perform-ocr-on-image-in-c-complete-aspose-ocr-example/)
Полное руководство по выполнению OCR изображения в C# с использованием Aspose OCR.
### [Пакетная обработка OCR в C# – Быстрое преобразование изображений в текст](./batch-ocr-processing-in-c-convert-images-to-text-quickly/)
Узнайте, как выполнять пакетную обработку изображений с помощью Aspose.OCR в C#, быстро конвертируя их в текст.
### [Распознать текст с изображения в C# с Aspose OCR – Полное руководство](./recognize-text-from-image-in-c-with-aspose-ocr-complete-guid/)
Полное руководство по распознаванию текста с изображений в C# с использованием Aspose OCR. Пошаговые инструкции для быстрой интеграции.
### [Извлечение текста из DjVu с C# – Полное руководство](./extract-text-from-djvu-with-c-complete-guide/)
Полное руководство по извлечению текста из файлов DjVu с помощью C# и Aspose.OCR.
