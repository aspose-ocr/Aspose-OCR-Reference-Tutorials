...
language: en
og_description: Create searchable PDF in Java with Aspose OCR. This tutorial shows
  how to compress images in PDF, convert scanned image to PDF, and disable font embedding
  PDF.
og_title: Create Searchable PDF in Java – Step‑by‑Step Guide
schemas:
- author: Aspose
...
- OCR
- PDF
title: Create Searchable PDF in Java – Complete Guide
url: /java/ocr-operations/create-searchable-pdf-in-java-complete-guide/
---
...
# Create Searchable PDF in Java – Complete Guide

Ever needed to **create searchable PDF** from a scanned document but felt stuck at the “how‑do‑I‑do‑that” part? You’re not alone. In many projects, turning a TIFF or JPEG into a PDF that you can actually search is a *must‑have* feature, especially when you also want to **compress images in PDF** to keep file sizes manageable.  

In this tutorial we’ll walk through a hands‑on example using Aspose OCR for Java. By the end you’ll know exactly how to **convert scanned image to PDF**, tweak the **compress images in PDF** setting, and even **disable font embedding PDF** to shave off a few extra kilobytes. No fluff—just a complete, runnable solution you can drop into your codebase today.

## What You’ll Learn

- Set up the Aspose OCR engine in a Java project.  
- Perform OCR on a TIFF (or any raster image).  
- Configure `PdfSaveOptions` to **compress images in PDF** and **disable font embedding PDF**.  
- Save the result as a **searchable PDF** that you can index or search instantly.  

**Prerequisites**  
- Java 8 or newer installed.  
- Maven or Gradle for dependency management (we’ll show the Maven snippet).  
- A scanned image file (TIFF, PNG, or JPEG) ready to be processed.  
