...
description: Create searchable PDF from a scanned image PDF using Aspose OCR. Learn
  how to convert scanned image PDF to PDF/A‑2b and extract text PDF in minutes.
draft: false
keywords:
...
language: en
og_description: Create searchable PDF from scanned images. This guide shows how to
  convert scanned image PDF to PDF/A‑2b and extract text PDF using Aspose OCR.
...
- OCR
- PDF/A
title: Create Searchable PDF in C# – Step‑by‑Step Guide
url: /net/text-recognition/create-searchable-pdf-in-c-step-by-step-guide/
---
...
# Create Searchable PDF in C# – Complete Tutorial
