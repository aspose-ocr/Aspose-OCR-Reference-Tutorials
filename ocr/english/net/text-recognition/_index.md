...
Learn how to convert OCR image results to JSON format using Aspose.OCR in C#.
...
### [How to convert an OCR image to JSON in C# with Aspose.OCR](./how-to-convert-an-ocr-image-to-json-in-c-with-aspose-ocr/)
Learn how to convert OCR image results to JSON format using Aspose.OCR in C#.
