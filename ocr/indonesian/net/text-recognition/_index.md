...
### [Cara mengonversi gambar OCR ke JSON di C# dengan Aspose.OCR](./how-to-convert-an-ocr-image-to-json-in-c-with-aspose-ocr/)
Pelajari cara mengonversi hasil OCR menjadi format JSON menggunakan Aspose.OCR di C#.
