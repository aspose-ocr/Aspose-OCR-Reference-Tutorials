...
### [استخراج النص من الصورة باستخدام Aspose OCR في C#](./extract-text-from-image-using-aspose-ocr-in-c/)
تعلم كيفية استخراج النص من الصور باستخدام Aspose OCR في بيئة C# بسهولة وفعالية.
