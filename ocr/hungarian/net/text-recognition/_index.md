...
### [Kép szövegének kinyerése Aspose OCR segítségével C#-ban](./extract-text-from-image-using-aspose-ocr-in-c/)
Ismerje meg, hogyan nyerhet ki szöveget képekből C#-ban az Aspose OCR használatával.
