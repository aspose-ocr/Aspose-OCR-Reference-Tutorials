...
### [Kereshető PDF létrehozása PNG-ből C#-ban – Teljes útmutató](./create-searchable-pdf-from-png-in-c-complete-guide/)
Ismerje meg, hogyan hozhat létre kereshető PDF-et PNG képekből C#-ban az Aspose OCR segítségével.
...
### [Hogyan konvertáljunk OCR képet JSON formátumba C#-ban az Aspose.OCR-rel](./how-to-convert-an-ocr-image-to-json-in-c-with-aspose-ocr/)
Tanulja meg, hogyan alakítsa át az OCR képet JSON formátumba C#-ban az Aspose.OCR segítségével.
